...
\begin{enumerate}
\item I really love minimalism in objects and spaces, but not necessarily at home.  I like to work in places like that.  I love the idea of attaching functions or activities to places.  I want to work in a minimalist building with high ceilings and talk with colleagues for hours about product design.
\item When it comes to improving my thought patterns, there are a few things that seem to work consistently.  One is to quickly address the thought and change it.  The sooner the easier.  Another is to distract myself with work or Whitney or friends.  I can pray to Heavenly Father and explain my situation.  Finally, I can prevent myself from having the thought in the first place, by keeping busy and thinking pure things.   
\item When it comes to stocks, I tend to do poorly with ultra high risk.  I'm okay taking the plunge, I just usually make bad decisions afterward, and since they are very costly under high risk, it usually loses me the majority of the account value. 
\item I love the idea of tools to think new ways and new thoughts:  those asian kids that do crazy math with an abacus, brett victor's ideas, the creativity program I wrote in R.  Convergent, vs. divergent vs. idea manipulation aids. (abacus, random idea generator, algebraic notation.)  Imagine a 3D graph of your profits, and you could play endlessly with different numbers.  
\item My sweet spot is to apply structural models.  I don't want to invent them.  It's not fun or interesting.  I want to be good at figuring out questions. 
\end{enumerate}

This is a list of more general observations.
\begin{enumerate}
