...
\item \textbf{Balloon Suit} A suit that you fill with helium that makes you slightly lighter.  Or a harness attached to a weather balloon (or several).  Could be really cool.
